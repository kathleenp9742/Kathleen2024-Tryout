...
import frc.robot.commands.DriveResetSwerveModules;
import frc.robot.commands.DriveSetState;
import frc.robot.commands.DriveStraight;
import frc.robot.commands.DriveToPose;
import frc.robot.commands.DriveTrajectory;
import frc.robot.commands.DriveTurnCalibration;
import frc.robot.commands.DriveWithJoysticksAdvance;
import frc.robot.commands.DriveZeroGyro;
import frc.robot.commands.ElevatorCalibrateEncoderIfAtLowerLimit;
...
import frc.robot.commands.ElevatorWristXboxControl;
...
import frc.robot.commands.LEDSetPattern;
import frc.robot.commands.LEDSetStrip;
...
import frc.robot.commands.ManipulatorStopMotor;
import frc.robot.commands.ManipulatorTogglePiston;
import frc.robot.commands.StickyFaultsClear;
import frc.robot.commands.WristSetAngle;
import frc.robot.commands.WristSetPercentOutput;
import frc.robot.commands.autos.ActiveBalance;
import frc.robot.commands.sequences.DriveToLoad;
...
import frc.robot.commands.sequences.LoadPieceLoadingStation;
...
public class RobotContainer {
  ...
  private void configureShuffleboard() {
    ...
    SmartDashboard.putData("Drive Trajectory Absolute", new DriveTrajectory(CoordType.kAbsolute, StopType.kBrake, 
        trajectoryCache.cache[TrajectoryType.test.value], driveTrain, log));  
    SmartDashboard.putData("Barrel Path", new DriveTrajectory(CoordType.kAbsoluteResetPose, StopType.kBrake, 
        trajectoryCache.cache[TrajectoryType.BarrelPath.value], driveTrain, log));
